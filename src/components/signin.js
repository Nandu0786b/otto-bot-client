    ...
    const handleSignin=async (e)=>{
      try {
        ...
        const response=await fetch("http://localhost:3001/v1/user/login",{
            ...
            body: JSON.stringify({email:iemail,pass:ipassword})
        ...
        if(json.Verified===true){
          ...
          localStorage.setItem("token",json.profile.token)
...
<div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div className="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Sign in to stock alert</h2>
  </div>
